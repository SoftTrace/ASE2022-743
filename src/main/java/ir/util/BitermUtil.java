...
public class BitermUtil {
    ...
    private static String titleBitermDirPath;
    private static String mfBitermDirPath;
    private static String preconBitermDirPath;
    private static String sfBitermDirPath;
    private static String afBitermDirPath;

    private static String descripBitermDirPath;
    private static String summBitermDirPath;
    ...
    private static Map<String, Map<String, Integer>> getStanfordReqBitermMap(Map<String, List<List<String>>> codeBitermMap) {
        ...
        if (projectEnum.getName().equals(ProjectEnum.MAVEN.getName())
            ...
            readLayerBiterm(LayerEnum.SUMMARY, summBitermDirPath, reqBitermsNumMap, bag);
            readLayerBiterm(LayerEnum.DESC, descripBitermDirPath, reqBitermsNumMap, bag);
        } else {
            readLayerBiterm(LayerEnum.TITLE, titleBitermDirPath, reqBitermsNumMap, bag);
            readLayerBiterm(LayerEnum.PRE_CON, preconBitermDirPath, reqBitermsNumMap, bag);
            readLayerBiterm(LayerEnum.MAIN_FLOW, mfBitermDirPath, reqBitermsNumMap, bag);
            readLayerBiterm(LayerEnum.SUB_FLOW, sfBitermDirPath, reqBitermsNumMap, bag);
            readLayerBiterm(LayerEnum.ALT_FLOW, afBitermDirPath, reqBitermsNumMap, bag);
        }
    ...
    private static Map<String, List<List<String>>> getBitermMap() {
        ...
        File dir = new File(classNameDir);
        for (File file : dir.listFiles()) {
            if (!file.getName().contains(".txt")) continue;
        ...
        File[] clsNameFiles = new File(classNameDir).listFiles();
        ...
        File[] funcNameFiles = new File(methodNameDirPath).listFiles();
    ...
    private static Map<String, List<List<String>>> expandBiterm(Map<String, List<List<String>>> map) {
        File[] invokeFiles = new File(invokeMethodDirPath).listFiles();
        ...
        File[] fieldNameFiles = new File(fieldNameDirPath).listFiles();
        ...
        File[] fieldTypeFiles = new File(fieldTypeDirPath).listFiles();
        ...
        File[] paramNameFiles = new File(paramNameDirPath).listFiles();
        ...
        File[] paramTypeFiles = new File(paramTypeDirPath).listFiles();
        ...
        File dir = new File(commentBitermDirPath);
        for (File file : dir.listFiles()) {
            if (!file.getName().contains(".txt")) continue;
